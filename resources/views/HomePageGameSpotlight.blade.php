                    ...
                    <div class="col-10 col-md-6 pb-5">
                        <div class="card mb-3">
                            <div class="row g-0">
                                ...
                                <img src="https://static-it.gamestop.it/images/products/307649/3max.jpg" style ="height: 300px" class="w-100 rounded-start" alt="...">
                                </div>
                                <div class="col-12 col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Zelda Tears of the Kingdom</h5>
                                    <p class="card-text">The Legend of Zelda: Tears of the Kingdom arriverà su Nintendo Switch il 12 maggio 2023. In questo seguito di The Legend of Zelda: Breath of the Wild, l'avventura di Link si svolgerà anche nei cieli al di sopra delle vaste terre di Hyrule.</p>
                                    <button class="button-89" role="button">Scopri di Più!</button>
                                </div>
                                </div>
                            </div>
                            </div>
